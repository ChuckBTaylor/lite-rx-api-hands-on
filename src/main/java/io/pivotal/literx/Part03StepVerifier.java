...
//========================================================================================
	...
	void expectSkylerJesseComplete(Flux<User> flux) {
		StepVerifier.create(flux).expectNextMatches(it -> "swhite".equals(it.getUsername()))
				.expectNextMatches(it -> "jpinkman".equals(it.getUsername())).verifyComplete();
		;
	}
...
//========================================================================================
	...
	void expect3600Elements(Supplier<Flux<Long>> supplier) {
		StepVerifier.withVirtualTime(supplier).thenAwait(Duration.ofSeconds(1)).expectNext(0L)
				.thenAwait(Duration.ofSeconds(3599)).expectNextCount(3599).expectComplete()
